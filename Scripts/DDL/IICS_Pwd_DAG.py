...
iics_username = "deepbhattacharyya@deloitte.com"
iics_password = "Bha500082TS"
task_type = 'TASKFLOW'
base_url = "https://app.informaticaondemand.com/ma/api/v2/user/login"
CDI_task_name = ["Taskflowtest_Airflow"]
...
default_args = {
   ...
   'owner': 'deepbhattacharyya@deloitte.com',
